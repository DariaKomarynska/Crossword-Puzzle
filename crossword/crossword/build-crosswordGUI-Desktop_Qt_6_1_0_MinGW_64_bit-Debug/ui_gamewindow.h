...
public:
    ...
    void setupUi(QWidget *gameWindow)
    {
        ...
        QBrush brush1(QColor(255, 184, 151, 255));
        ...
        QPalette palette1;
        QBrush brush2(QColor(255, 78, 246, 255));
        ...
        QBrush brush6(QColor(255, 85, 255, 255));
        ...
        QBrush brush8(QColor(85, 85, 255, 255));
